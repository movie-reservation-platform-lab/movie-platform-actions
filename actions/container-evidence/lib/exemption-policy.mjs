 ...
 */
export function componentName(untrustedComponentName) {
 ...
 */
export function parseExemption(untrustedRecord) {
    ...
    return structuredClone(untrustedRecord);
}
/**
 ...
 */
function validateExemptionIdentity(record) {
 ...
 */
function validatePackageScope(record) {
 ...
 */
function validateApproval(record, exemptionType) {
 ...
 */
function validateVex(untrustedVex, identity, purl, approval) {
 ...
 */
function validateVexStatement(untrustedStatement, identity, purl) {
...
export function exemptionDigest(record) {
...
export function parseExemptions(values, component) {
...
export function verifyExemptionSnapshot(used, trusted, component, now) {
