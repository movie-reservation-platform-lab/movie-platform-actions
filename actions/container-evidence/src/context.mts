...
if (version !== "v1alpha2" && version !== "v1alpha3") throw new Error("Unsupported evidence version");
if (profile.component === "reservation-service" && version !== "v1alpha3") throw new Error("Reservation-service requires explicit v1alpha3 evidence");
appendFileSync(
